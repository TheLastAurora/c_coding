...
#students = ('Amadeu L.', 'Anna C.', 'Augusto R.', 'Fillipe M.', 'Gabriel M.', 'Guilherme A.', 'Gustavo M.', 'Igor G.', 'Jonathan F.', 'Lucas B.', 'Lucas I.','Marcos R.', 'Matheus G.', 'Müller R.', 'Pedro L.', 'Rafael E.', 'Ricardo S.', 'Vitor L.', 'Wilker T.')
...
nx.draw_networkx_nodes(G, pos, nodelist=tuple(set(G.nodes()) & set(cs_course)), node_color="#F07030",)
nx.draw_networkx_nodes(G, pos, nodelist=tuple(set(G.nodes()) & set(se_course)), node_color="#59A3DD",)
nx.draw_networkx_edges(G, pos, edge_color=colors, width=2.0)
